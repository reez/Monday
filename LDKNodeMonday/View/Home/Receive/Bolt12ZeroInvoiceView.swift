...
struct Bolt12ZeroInvoiceView: View {
    @ObservedObject var viewModel: Bolt12ZeroInvoiceViewModel
    ...
    var body: some View {
        ...
        .onAppear {
            Task {
                await viewModel.receivePayment(description: "Monday Wallet")
                viewModel.getColor()
            }
        }
